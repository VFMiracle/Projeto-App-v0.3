      ...
      onUpgrade: (Database database, int oldVersionNumber, int newVersionNumber) async{
        ...
        database.execute(
          '''INSERT INTO command_history(id_used_command, nm_target, dt_history_creation, ds_update_info) VALUES (1, "Bruxeval", "2024-2-1 15:5:0", NULL),
            ...
            (8, "Bruxeval", "2023-2-2 6:12:38", 'da_record_date:2024-2-2, in_initial_value:1200'),
            (9, "Grumadzul", "2024-2-2 6:21:4", 'da_record_date:2024-2-2, in_delete_value:600'),
            (10, "Arstuncio", "2024-2-2 6:41:24", 'da_record_date:2024-2-1, st_new_name:Grumadzul'),
            (11, "Burxeval", "2023-2-2 7:2:51", 'da_record_date:2024-2-2, in_oldValue:1200, in_newValue:4500');'''
        );
      },
      version: 14,
    );
