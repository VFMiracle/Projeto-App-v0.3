...
import 'package:projeto_time_counter/old_themes/old_main_dialog_theme.dart';

abstract class OldMainTheme{
  ...
  static ThemeData build(){
    ...
    return ThemeData(
      ...
      dialogTheme: OldMainDialogTheme.build(Colors.white, primaryColor),
